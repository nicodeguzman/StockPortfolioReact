...
// render portfolio in tbody
    ...
    return (
        <div className="container">
            <h1 className="text-center my-4">React Stock Portfolio</h1>
            <div className="row">
                        ...
                        <tbody>
                            {portfolio.map((stock, index) => {
                                ...
                                return (
                                    <tr key={index}>
                                        <td>{name}</td>
                                        <td><input onChange={e => this.handleChange(e, index)}
                        type="number" name="shares_owned" value={shares_owned} /></td>
                                        <td><input onChange={e => this.handleChange(e, index)}
                        type="number" name="cost_per_share" value={cost_per_share} /></td>
                                        <td><input onChange={e => this.handleChange(e, index)}
                        type="number" name="market_price" value={market_price} /></td>
                                    <td>{market_value}</td>
            ...
            <form className="col-12 mt-2 mb-4" onSubmit={this.addStock}>
                ...
                <div className="col-12 col-md-6">
                    <h4 className="mb-3">Portfolio market Value: $ {portfolio_market_value}</h4>
                </div>
                <div className="col-12 col-md-6">
